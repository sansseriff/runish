import"../chunks/CWj6FrbW.js";import"../chunks/69_IOA4Y.js";import{c as a,b as i}from"../chunks/Bzlu6mDn.js";var o=a(`<div class="prose max-w-none w-full mx-auto mt-6 lg:pr-4 svelte-1gtsq86"><div class="border-y lg:border-t-0 border-gray-300 dark:border-gray-700 p-6 h-37 relative"><h2 class="font-serif font-medium lg:h-4 justify-end flex-col block mt-16 dark:text-gray-400">Ironfell — software for science authorship</h2> <div class="absolute size-2 z-10 rounded-[1px] rotate-45 border border-gray-300 dark:border-gray-700 bg-gray-50 dark:bg-gray-900 left-[-4.5px] bottom-[-4.5px]"></div></div> <div class="font-serif font-medium p-7 px-8 dark:text-gray-400 border-y border-t-0 border-gray-300 dark:border-gray-700"><p>Below are some questions and answers about my work on a software tool for science publishing
			...
			theater and opera.</p> <p>AI tools now make superficially rigorous text nearly costless, creating a curation crisis in
			...
			teach and demonstrate research integrity more effectively.</p> <p>We need to guide the move away from static PDFs in favor of new abstract synthesis formats
