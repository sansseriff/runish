import{w as a,a as i,f as o}from"../chunks/DGr7l9r8.js";import"../chunks/kRdYIFkv.js";var r=a(o(`<div class="prose max-w-none w-full mx-auto mt-6 lg:pr-4 svelte-1j3hklw"><div class="border-y lg:border-t-0 border-gray-300 dark:border-gray-700 p-6 h-37 relative"><h2 class="font-serif font-medium lg:h-4 justify-end flex-col block mt-16 dark:text-gray-400">Ironfell — software for science authorship</h2> <div class="absolute size-2 z-10 rounded-[1px] rotate-45 border border-gray-300 dark:border-gray-700 bg-gray-50 dark:bg-gray-900 left-[-4.5px] bottom-[-4.5px]"></div></div> <div class="font-serif font-medium p-7 px-8 dark:text-gray-400 border-y border-t-0 border-gray-300 dark:border-gray-700"><p>Below are some questions and answers about my work on a software tool for science publishing
			...
			presented at Force11 2024 [1], built with typescript and a library called Motion Canvas:</p> <div class="video-container my-6 svelte-1j3hklw"><iframe src="https://www.youtube.com/embed/41owusgOsOU?si=sr2YMaKwnuXSnCcV" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen="" class="svelte-1j3hklw"></iframe></div> <p>Currently, I'm using the Rust-based Bevy game engine [2] (compiled to web assembly) and am
