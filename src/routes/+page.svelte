...
<div class="prose max-w-none w-full mx-auto mt-6 lg:pr-4">
	<div class="border-y lg:border-t-0 border-gray-300 dark:border-gray-700 p-6 lg:h-37 relative">
		<h1 class="font-serif font-medium lg:h-4 dark:text-gray-400">Hi, I'm Andrew</h1>
		<p class="font-serif font-medium dark:text-gray-400">
